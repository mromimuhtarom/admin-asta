...
<li class="breadcrumb-item menunameheader"><a href="{{ route('Email_Notification') }}">Notification</a></li>
        <li class="breadcrumb-item menunameheader"><a href="{{ route('Email_Notification') }}">Email Notification</a></li>
@endsection
...
<div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-sitemap"></i> Email Notification</strong></h2>				
      </div>
    </header>
