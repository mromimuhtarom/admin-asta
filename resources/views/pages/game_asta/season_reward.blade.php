            ...
            <table class="table table-bordered">
              ...
              <tbody>
                @foreach($reward as $rd)
                  <tr>
                    <td><input type="checkbox" name="deletepermission" class="deletepermission{{ $rd->id }}"></td>
                    <td>
                    ...
                    <td><a href="#" style="color:red;" class="delete{{ $rd->id }}" id="delete" data-pk="{{ $rd->id }}" data-toggle="modal" data-target="#delete-sReward"><i class="fa fa-times"></i></a></td>
                  </tr>
                @endforeach
              </tbody>
            </table>
