...
<li class="breadcrumb-item"><a href="{{ route('DominoQTable-view') }}">Games > Domino QQ</a></li>
        <li class="breadcrumb-item"><a href="{{ route('DominoQTable-view') }}">Table</a></li>
@endsection
              ...
              <tbody>
                @foreach($tables as $tb)
                  <tr>
                    ...
                    <td><a href="#" class="usertext" data-title="Table Name" data-name="name" data-pk="{{ $tb->tableid }}" data-type="text" data-url="{{ route('DominoQTable-update')}}">{{ $tb->name }}</a></td>
                    <td><a href="#" class="room" data-title="Room name" data-name="roomid" data-pk="{{ $tb->tableid }}" data-type="select" data-url="{{ route('DominoQTable-update')}}">{{ $tb->roomname }}</a></td>
                    <td><a href="#" class="usertext" data-title="Max Player" data-name="max_player" data-pk="{{ $tb->tableid }}" data-type="number" data-url="{{ route('DominoQTable-update')}}">{{ $tb->max_player }}</a></td>
                    <td><a href="#" class="usertext" data-title="Game State" data-name="game_state" data-pk="{{ $tb->tableid }}" data-type="number" data-url="{{ route('DominoQTable-update')}}">{{ $tb->game_state }}</a></td>
                    <td><a href="#" class="usertext" data-title="Current Turn Seat ID" data-name="current_turn_seatid" data-pk="{{ $tb->tableid }}" data-type="number" data-url="{{ route('DominoQTable-update')}}">{{ $tb->current_turn_seatid }}</a></td>
                    <td><a href="#" class="usertext" data-title="Total Bet" data-name="total_bet" data-pk="{{ $tb->tableid }}" data-type="number" data-url="{{ route('DominoQTable-update')}}">{{ $tb->total_bet }}</a></td>
