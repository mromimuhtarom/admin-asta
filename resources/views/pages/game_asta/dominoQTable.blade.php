              ...
              <tbody>
                ...
                @if($menu)
                  <tr>
                    ...
                    <td><a href="#" class="room" data-title="Room name" data-name="roomid" data-pk="{{ $tb->table_id }}" data-type="select" data-url="{{ route('DominoQTable-update')}}">{{ $tb->roomname }}</a></td>
                    ...
                    <td><a href="#" class="usertext" data-title="Current Turn Seat ID" data-name="current_turn_seatid" data-pk="{{ $tb->table_id }}" data-type="number" data-url="{{ route('DominoQTable-update')}}">{{ $tb->current_turn_seat_id }}</a></td>
