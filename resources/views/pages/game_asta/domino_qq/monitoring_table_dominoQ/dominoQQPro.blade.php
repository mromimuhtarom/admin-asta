...
@section('page')
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoQ') }}">Games > Domino QQ</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoQ') }}">Monitoring Table</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoQ') }}">Pro</a></li>
@endsection
