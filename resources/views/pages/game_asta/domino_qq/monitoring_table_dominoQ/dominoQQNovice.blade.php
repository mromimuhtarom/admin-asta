...
@section('page')
    <li class="breadcrumb-item"><a href="{{ route('Novice_DominoQ') }}">Games > Domino QQ</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Novice_DominoQ') }}">Monitoring Table</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Novice_DominoQ') }}">Novice</a></li>
@endsection
