...
@section('page')
<li class="breadcrumb-item menunameheader"><a href="{{ route('Monitoring_Table_DominoQ') }}">Games > Domino QQ</a></li>
<li class="breadcrumb-item menunameheader"><a href="{{ route('Monitoring_Table_DominoQ') }}">Monitoring Table</a></li>
<li class="breadcrumb-item menunameheader"><a href="{{ route('Monitoring_Table_DominoQ') }}">Novice</a></li>
@endsection
          ...
          <div class="table-outer">
            <div class="row">
              <div class="col-9 col-sm-5 col-md-5 col-lg-5" style="font-style:italic;color:#969696;font-weight:bold;">
                {{ Translate_menuPlayers('L_TOTAL_RECORD') }} {{ $dmqPlayersNovice->total() }}
            </div>
            </div>
      ...
      @elseif(Request::is('Game/Domino-QQ/Monitoring_Table_DominoQ/Monitoring_Domino_QQ-intermediate*'))
        ...
        <div class="custom-scroll table-responsive" style="height:800px;">
          <div class="table-outer">
            <div class="row">
              <div class="col-9 col-sm-5 col-md-5 col-lg-5" style="font-style:italic;color:#969696;font-weight:bold;">
                {{ Translate_menuPlayers('L_TOTAL_RECORD') }} {{ $dmqPlayersintermediate->total() }}
              </div>
            </div>
        ...
        <div class="custom-scroll table-responsive" style="height:800px;">
          <div class="table-outer" id="Novice">
            <div class="row">
              ...
              <div class="col-9 col-sm-5 col-md-5 col-lg-5" style="font-style:italic;color:#969696;font-weight:bold;">
                  {{ Translate_menuPlayers('L_TOTAL_RECORD') }} {{ $dmqPlayersPro->total() }}
              </div>
