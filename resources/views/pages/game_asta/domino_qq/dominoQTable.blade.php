...
@section('page')
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Table_Domino_QQ') }}">Domino QQ</a></li>
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Table_Domino_QQ') }}">{{ TranslateMenuGame('L_TABLE') }}</a></li>
@endsection
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-table"></i>{{ TranslateMenuGame('L_TABLE') }} Asta Domino QQ</strong></h2>				
      </div>
    </header>
              ...
              <tbody>
                ...
                @if($menu && $mainmenu && $submenu)
                  <tr>
                    ...
                    <td><a href="#" class="seatplayer" data-title="Max Player" data-name="max_player" data-pk="{{ $tb->table_id }}" data-type="select" data-url="{{ route('DominoQTable-update')}}">{{ $tb->max_player }}</a></td>
