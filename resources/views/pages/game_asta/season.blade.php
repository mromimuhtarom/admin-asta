          ...
          <div class="table-outer">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                @endphp
                <tr>
                    <td><input type="checkbox" name="deletepermission" class="deletepermission{{ $sn->seasonId }}"></td>
                    ...
                    <td><a href="#" style="color:red;" class="delete{{ $sn->seasonId }}" id="delete" data-pk="{{ $sn->seasonId }}" data-toggle="modal" data-target="#delete-season"><i class="fa fa-times"></i></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
