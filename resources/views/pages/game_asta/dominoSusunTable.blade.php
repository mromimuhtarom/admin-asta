...
<li class="breadcrumb-item"><a href="{{ route('Table_Domino_Susun') }}">Games > Domino Susun</a></li>
        <li class="breadcrumb-item"><a href="{{ route('Table_Domino_Susun') }}">Table</a></li>
@endsection
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-puzzle-piece"></i> Asta Domino Susun Table</strong></h2>				
      </div>
    </header>
              ...
              <tbody>
                ...
                @if($menu)
                  <tr>
                    ...
                    <td><a href="#" class="room" data-title="Room name" data-name="roomid" data-pk="{{ $tb->table_id }}" data-type="select" data-url="{{ route('DominoSTable-update')}}">{{ $tb->roomname }}</a></td>
                    ...
                    <td><a href="#" class="usertext" data-title="Current Turn Seat ID" data-name="current_turn_seatid" data-pk="{{ $tb->table_id }}" data-type="number" data-url="{{ route('DominoSTable-update')}}">{{ $tb->current_turn_seat_id }}</a></td>
