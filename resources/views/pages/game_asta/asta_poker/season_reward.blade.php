...
<li class="breadcrumb-item menunameheader"><a href="{{ route('Season_Reward_Asta_Poker') }}">Games > Asta Poker</a></li>
        <li class="breadcrumb-item"><a href="{{ route('Season_Reward_Asta_Poker') }}">Season Reward</a></li>
@endsection
