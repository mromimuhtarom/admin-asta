...
<li class="breadcrumb-item"><a href="{{ route('BigTwoTournament-view') }}">Games > Big Two</a></li>
        <li class="breadcrumb-item"><a href="{{ route('BigTwoTournament-view') }}">Tournament</a></li>
@endsection
