...
@section('page')
<li class="breadcrumb-item"><a href="{{ route('Intermediate_Big_Two') }}">Games > Asta Poker</a></li>
<li class="breadcrumb-item"><a href="{{ route('Intermediate_Big_Two') }}">Monitoring Table</a></li>
<li class="breadcrumb-item"><a href="{{ route('Intermediate_Big_Two') }}">Intermediate</a></li>
@endsection
      ...
      <div class="widget-body">
        <div class="widget-body-toolbar">
          <div class="row">
            ...
            <div style="float:left;margin-right:1%;">{{ TranslateMenuGame('Online') }}</div><div class="border" style="width:min-content;padding-left:1%;padding-right:1%;float:left;margin-right:1%;">{{ count($bgtPlayers) }}</div> <div style="margin-right:2%;float:left;">{{ TranslateMenuGame('Players') }}</div><a href="#" id="refreshtable" class="btn sa-btn-primary btn-xs" style="float:left;">Refresh</a>
            </div>
