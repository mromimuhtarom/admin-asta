...
@section('page')
<li class="breadcrumb-item"><a href="{{ route('Novice_Big_Two') }}">Games > Asta Poker</a></li>
<li class="breadcrumb-item"><a href="{{ route('Novice_Big_Two') }}">Monitoring Table</a></li>
<li class="breadcrumb-item"><a href="{{ route('Novice_Big_Two') }}">Novice</a></li>
@endsection
