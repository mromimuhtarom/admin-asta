...
@section('page')
  ...
  <li class="breadcrumb-item"><a href="{{ route('Table_Big_Two') }}">{{ TranslateMenuGame('Table') }}</a></li>
@endsection
...
@section('content')
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-table"></i>{{ TranslateMenuGame('Asta Big Two Table') }}</strong></h2>				
      </div>
    </header>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="th-sm">{{ TranslateMenuGame('Turn') }}</th>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="form-group">
                  <input type="number" class="form-control required" id="stake" name="stake" placeholder="Stake" required="" >
                </div>
                <div class="form-group">
                  <input type="number" class="form-control required" id="minbuy" name="minbuy" placeholder="Min Buy" required="">
                  <span id="lblErrorminbuy" style="color: red"></span>
                </div>
                <div class="form-group">
                  <input type="number" class="form-control required" id="maxbuy" name="maxbuy" placeholder="Max Buy" required="">
  ...
  <script>
    ...
    //Disable submit unti all form fullfilled
  ...
  <script type="text/javascript">
    ...
    $("#stake").keyup(function(e) {
      ...
      echo 'var lblErrorminbuy = document.getElementById("lblErrorminbuy");';
        ...
        echo '} else {';
          ...
          echo 'lblErrormaxbuy.innerHTML = "Max buy table melebihi dari max buy di kategori.";';
    ...
    // $("#category_table").on('change', function(){
