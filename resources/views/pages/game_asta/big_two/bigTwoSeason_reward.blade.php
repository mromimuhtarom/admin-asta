...
<li class="breadcrumb-item menunameheader"><a href="{{ route('Season_Reward_Big_Two') }}">Games > Big Two</a></li>
        <li class="breadcrumb-item"><a href="{{ route('Season_Reward_Big_Two') }}">Season Reward</a></li>
@endsection
