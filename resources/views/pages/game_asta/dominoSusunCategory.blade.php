...
@section('page')
  ...
  <li class="breadcrumb-item"><a href="{{ route('Category_Domino_Susun') }}">{{ TranslateMenuGame('Category') }}</a></li>
@endsection
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-puzzle-piece"></i>{{ TranslateMenuGame('Table') }} Domino Susun</strong></h2>				
      </div>
    </header>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  {{-- <th></th> --}}
                  @endif
                  <th class="th-sm">{{ TranslateMenuGame('Room Name') }}</th>
