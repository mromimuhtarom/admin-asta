...
<li class="breadcrumb-item"><a href="{{ route('Category_Domino_Susun') }}">Games > Domino Susun</a></li>
        <li class="breadcrumb-item"><a href="{{ route('Category_Domino_Susun') }}">Category</a></li>
@endsection
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><a href="#" class="usertext" data-title="Stake Pass" data-name="stake_pass" data-pk="{{ $kt->room_id }}" data-type="number" data-url="{{ route('DominoSCategory-update')}}">{{ $kt->stake_pass }}</a></td>
