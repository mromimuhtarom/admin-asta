...
@section('page')
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Category_Domino_Susun') }}">Domino Susun</a></li>
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Category_Domino_Susun') }}">{{ TranslateMenuGame('L_CATEGORY') }}</a></li>
@endsection
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-puzzle-piece"></i>{{ TranslateMenuGame('L_TABLE') }} Domino Susun</strong></h2>				
      </div>
    </header>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  {{-- <th></th> --}}
                  @endif
                  <th class="th-sm">{{ TranslateMenuGame('L_ROOM_NAME') }}</th>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><a href="#" class="usertext" data-title="Min Buy" data-name="min_buy" data-pk="{{ $kt->room_id }}" data-type="number" data-url="{{ route('DominoSCategory-update') }}">{{ number_format($kt->min_buy, 2) }}</a></td>
                    <td><a href="#" class="usertext" data-title="Max Buy" data-name="max_buy" data-pk="{{ $kt->room_id }}" data-type="number" data-url="{{ route('DominoSCategory-update') }}">{{ number_format($kt->max_buy, 2) }}</a></td>
