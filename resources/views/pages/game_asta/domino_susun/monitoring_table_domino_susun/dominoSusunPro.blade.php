...
@section('page')
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoS') }}">Games / Domino Susun</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoS') }}">Monitoring Table</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Pro_DominoS') }}">Pro</a></li>
@endsection
