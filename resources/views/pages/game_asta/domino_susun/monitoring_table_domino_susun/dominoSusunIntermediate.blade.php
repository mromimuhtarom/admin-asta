...
@section('page')
    <li class="breadcrumb-item"><a href="{{ route('Intermediate_DominoS') }}">Games > Domino Susun</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Intermediate_DominoS') }}">Monitorin Table</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Intermediate_DominoS') }}">Intermediate</a></li>
@endsection
    ...
    <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
        <header>
            <div class="widget-header">
                <h2><strong><i class="fa fa-puzzle-piece">Domino Susun</i></strong></h2>
            </div>
        </header>
