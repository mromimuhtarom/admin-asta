...
<li class="breadcrumb-item"><a href="{{ route('Category_Domino_QQ') }}">Domino QQ</a></li>
        <li class="breadcrumb-item"><a href="{{ route('Category_Domino_QQ') }}">{{ TranslateMenuGame('Category') }}</a></li>
@endsection
  ...
  <div class="jarviswidget jarviswidget-color-blue-dark no-padding" id="wid-id-18" data-widget-colorbutton="false" data-widget-editbutton="false">
    <header>
      <div class="widget-header">	
        <h2><strong><i class="fa fa-puzzle-piece"></i>{{ TranslateMenuGame('Table') }} Domino QQ</strong></h2>				
      </div>
    </header>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><a href="#" class="usertext" data-title="Min Buy" data-name="min_buy" data-pk="{{ $kt->room_id }}" data-type="number" data-url="{{ route('DominoQCategory-update') }}">{{ number_format($kt->min_buy, 2) }}</a></td>
                    <td><a href="#" class="usertext" data-title="Max Buy" data-name="max_buy" data-pk="{{ $kt->room_id }}" data-type="number" data-url="{{ route('DominoQCategory-update') }}">{{ number_format($kt->max_buy, 2) }}</a></td>
