    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header" style="margin-top:5%;">
          <h5 class="modal-title" id="exampleModalLabel">Create Gold Store</h5>
        ...
        <div class="modal-body">
            ...
            <input type="number" name="goldawarded" placeholder="Gold Awarded"><br>
            <input type="number" name="pricecash" placeholder="Price Cash"><br>
    ...
    <div class="table-aii">
        <div class="footer-table">
                            <button type="button" class="btn btn-primary add-btn" data-toggle="modal" data-target="#basicExampleModal">
                              <i class="fas fa-plus-circle"></i>Create Gold Store
                            </button>
        </div>
