...
@section('page')
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Registered_Players') }}">{{ Translate_menuPlayers('L_PLAYERS') }}</a></li>
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Registered_Players') }}">{{ Translate_menuPlayers('L_REGISTERED_PLAYER') }}</a></li>
@endsection
              ...
              <div class="form-group" id="formGroup">
                <div style="height:100px;overflow:auto;margin-bottom:20px;" class="border border-dark">
                  <table width="100%" style="border:1px solid #dee2e6;">
                    ...
                    @php 
                      $loguser = App\LogUser::where('user_id', '=', $regis->user_id)->wherebetween('action_id', [55, 57])->get();
