...
@section('page')
    <li class="breadcrumb-item menunameheader"><a href="{{ route('Report_Players') }}">{{ Translate_menuPlayers('L_PLAYERS') }}</a></li>
    <li class="breadcrumb-item menunameheader"><a href="{{ route('Report_Players') }}">{{ Translate_menuPlayers('L_REPORT_PLAYER') }}</a></li>
@endsection
