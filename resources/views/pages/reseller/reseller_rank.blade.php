...
@section('page')
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Reseller_Rank') }}">{{ translate_menu('L_RESELLER')}}</a></li>
  <li class="breadcrumb-item menunameheader"><a href="{{ route('Reseller_Rank') }}">{{ translate_menu('L_RESELLER_RANK')}}</a></li>
@endsection
