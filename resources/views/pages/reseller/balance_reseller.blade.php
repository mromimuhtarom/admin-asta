...
@section('page')
    <li class="breadcrumb-item"><a href="{{ route('Balance_Reseller') }}">{{ translate_menu('L_RESELLER')}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Balance_Reseller') }}">{{ translate_menu('L_BALANCE_RESELLER')}}</a></li>
@endsection
