...
function translate_MenuTransaction($menu){
    ...
    $array_menuContent = [
        ...
        'L_CREATE_TRANSC_STORE' =>  'Create transaction store',
        'L_CLOSE'               =>  'close',
...
function TranslateGeneralSettings($menu){
    ...
    $array_menuContent = [
        ...
        'L_AWARD_DAILY_DAYS'          =>  'Daily award',
        'L_AWARD_DAILY_MULTIPLY'      =>  'Daily multiply award',
        'L_BANK_SETTINGS'             =>  'Bank Settings',
        'L_INFO_SETTINGS'             =>  'Info Settings',
        'L_ABOUT'                     =>  'About',
        'L_EDIT_ABOUT'                =>  'Edit About',
        'L_CS_LEGAL'                  =>  'CS & Legal Settings',
        'L_EDIT_PRIVACY_POL'          =>  'Edit Privacy & policy',
        'L_EDIT_TOS'                  =>  'Edit Term of service',
        'L_DAYS'                      =>  'Days',
        'L_EDIT_ASTA_POKER'           =>  'Edit Asta Poker',
        'L_EDIT_BIG_TWO'              =>  'Edit Big two',
        'L_EDIT_DOMINO_QQ'            =>  'Edit Domino QQ',
        'L_EDIT_DOMINO_SUSUN'         =>  'Edit Domino susun',
...
function TranslateReseller($menu){
    ...
    $array_menuContent = [
        ...
        'L_BONUS_ITEM'           => 'Bonus item',
        'L_BALANCE'              => 'Balance',
        'L_GOLD_GROUP'           => 'Gold Group',
        'L_CREATE_RESELLER_RANK' => 'Create Reseller Rank',
        'L_PASSWORD'             => 'Password',
        'L_IDENTITY_CARD'        => 'Identity Card',
        'L_ACCESS_DENIED'        => 'Access Denied',
        'L_UCANT_ACCESS'         => 'You cannot access',
        'L_CREATE_NEW_ASSET'     => 'Create New Asset',
        'L_LINK'                 => 'Link',
        'L_VERSION'              => 'Version',
        'L_EDIT_ASSET'           => 'Edit asset',
        'L_CHOOSE_FILE'          => 'Choose a file',
        'L_CREATE_NEW_RESELLER'  => 'Create new reseller',
        'L_SELECT_ALL'           => 'Select All',
        'L_WEEKLY'               => 'Weekly',
        'L_MONTHLY'              => 'Monthly',
        'L_YEARLY'               => 'Yearly',
...
function alertTranslate($menu){
    ...
    $array_menuContent = [
        ...
        "L_INSERT_DATA_SUCCESS"                                         =>  "Insert Data successfull",
        'L_INSERT_SUCCESSFULL'                                          =>  "Inser Data successfull",
        "L_SUCCESSFUL_IMAGE"                                            =>  "Successfull Image",
        "L_FAILED"                                                      =>  "Failed",
        "L_CANT_LESS_THAN"                                              =>  "end date can't be less than start date",
        "balance cannot be reduced"                                     =>  "balance cannot be reduced",
        "L_BALANCE_CANT_REDUCE_PLEASE"                                  =>  "balance cannot be reduced, please enter the appropriate amount",
        "L_SUCCESS_UPDATE"                                              =>  "Successfull update",
        "L_NAME_CANT_NULL"                                              =>  "Nama can't be Null",
        "L_FILE_MUST_JPG"                                               =>  "File extensions are not allowed, you must use .jpg",
        "L_UPDATE_IMG_SUCCESS"                                          =>  "Update image successfull",
        "L_MUST_JPG_PICT"                                               =>  "Format must be jpg and pictorial",
        "L_DATA_DELETED"                                                =>  "Date deleted",
        "L_SOMETHING_WRONG"                                             =>  "Something wrong",
        "L_MINMAX_MUST_FILLED"                                          =>  "Min Date and Max Date must be filled In",
        "L_DATA_ADDED"                                                  =>  "Data added",
        "L_MAXBUY_CANT_UNDER_MINBUY"                                    =>  "Max buy can't be under min buy",
        "L_SIZE_IMG_TOOBIG"                                             =>  "Size image it's too Big",
        "L_IMG_MUST_PNG"                                                =>  "Image must be in png",
        "L_PRICE_CANT_NULL"                                             =>  "Price can't be Null",
        "File extensions are not allowed"                               =>  "File extensions are not allowed",
        "L_DATA_UPDATED"                                                =>  "Data updated",
        "L_UPDATE_CANT_PROCCED"                                         =>  "Updated can't be process",
        "L_CATEGORY_CANT_NULL"                                          =>  "Category can't be Null",
        "L_IMG_HIGHT_MORETHAN_319PX_WIDTH_MORETHAN_384PX"               => "Your image source size height is more than 319 px dan width is more than 384",
        "L_MUST_PNG_PICT"                                               =>  "Format must be png and pictorial",
        "L_ID_MUSTBE_FILL"                                              =>  "ID must be fill",
        "L_USERNAME_PASS_WRONG"                                         =>  "Username or Password are wrong!",
        "L_UR_ALLREADY_LOGOUT"                                          =>  "You are already Log out",
        "L_UPDATE_STATS_SUCCESS"                                        =>  "Update status successfull",
        "L_INPUT_SUCCESS_WITH"                                          =>  "Input data successfull with",
        "L_INPUT_PID_CANT_NULL"                                         =>  "Number of inputs filled in player ID can't be NULL",
        "L_MUST_CHOOSE_STATS"                                           =>  "You must to choose status",
        "L_DATA_INPUT_SUCCESFULL"                                       =>  "Data input successfull", 
        "L_RESET_PASSWORD_SUCCESS"                                      =>  "Reset password successfull",
        "L_PASSWORD_NULL"                                               =>  "Password NULL",
        "L_REGISTER_SUCCESSFULL"                                        =>  "Register Successfull",
        "L_APPROVED_SUCCESSFULL"                                        =>  "Approved successfull",
        "L_DECLINED_SUCCESSFULL"                                        =>  "Declinde successfull",
        "L_SIZE_TOO_LARGE"                                              =>  "File size too large",
        "L_RECEIVE_REQUESTTRANSC_SUCCESS"                               =>  "Receiving request transaction has been successfull",
        "L_REJECT_REQTRANSC_SUCCESS"                                    =>  "Reject request Transaction has been successfull",
        "L_ROLE_NAME_NULL"                                              =>  "Role name is Null",
        "L_BIGBLIND_CANT_UNDER_MINBUY_DIVIDE10 "                        =>  "Your Big blind can't be under minbuy",
        "L_SMALLBLIND_CANT_UNDER_BIGBLIND_DIVIDE2 "                     =>  "Your small blind can't be under big blind divided 2",
        "L_MINBUYTAB_CANT_UNDER_MINBUY_ROOM"                            =>  "Min buy table can't be under min buy room",
        "L_MAXBUYT_CANT_UP_MACBUYR"                                     =>  "Max buy table can't be under max buy room",
        "L_MINBUY_CANT_UNDER_STAKE_X3X13_ORUNDER"                       =>  "Min Buy can't be under Stake multiplied by 3 multiplied 13 or under",
        "Max buy can't be under min buy"                                =>  "Max buy can't be under min buy",
        "L_MINBUY_CANT_UNDER_MAXBUY"                                    =>  "Min buy can't be under max buy",
        "L_MAXBUY_CANT_UPTO_MAXBUYR "                                   =>  "Max buy can't be up to max room max buy",
        "L_MAXBUY_CANT_UNDER_STAKEX10 "                                 =>  "Max buy can't be under Stake multiplied by 10 or under",
        "L_MAXBUY_CANT_UNDER_MINBUYX4 "                                 =>  "Max buy can't be under Min buy multiplied by 4 or under",
        "L_MINBUY_CANT_UNDER_STAKEX10 "                                 =>  "Min buy can't be under stake multiplied by 10 or under",
        "L_MAXBUY_CANT_UNDER_MINBUYX2 "                                 =>  "Max buy can't be under Min Buy multiplied by 2 or under",
        "L_SB_CANT_UNDER_BB_DIV2"                                       =>  "your Small Blind can't be under Big Blind divided 2 or under",
        "L_MAXBUY_CANT_UNDER_STAKEX2"                                   =>  "Max buy can't be under Stake multiplied by 2 or under",
        "L_MINBUY_CANT_UNDER_MINBUYROOM "                               =>  "Min buy can't be under to min buy room",
